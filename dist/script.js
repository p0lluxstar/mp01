...
/* harmony import */ var _modules_callback__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/callback */ "./src/js/modules/callback.js");

window.addEventListener('DOMContentLoaded', function () {
  //этот обработчик отвечает за то, что скрипты начинают выполнятся когда DOM дерево будет готова
  Object(_modules_callback__WEBPACK_IMPORTED_MODULE_0__["default"])();
});
